...
class Campaign extends MY_Controller {
    ...
    public function __construct() {
        parent::__construct();
        // $this->lang->load('social_campaigns', $this->language);
        // JsSettings::instance()->add([
        //     'i18n' => $this->lang->load('social_campaigns', $this->language)
        // ]);
    ...
    public function collection($type){ 
        if ($this->template->is_ajax()) {
            ...
            $campaigns = $campaigns->get_user_campaigns($this->c_user->id, $this->profile->id, $type, 'all');
