...
class Designer extends MY_Controller {
    ...
    public function __construct() {
        ...
        $pixabay = true;
        $this->has_pixalbay = true;
        if($aac->isGrantedPlan('pro_package')){
            $pixabay = false;
            $this->has_pixalbay = false;
        }
        // if($aac->isGrantedPlan('platinium_package')){
        //     $pixabay = false; 
        //     $this->has_pixalbay = false;         
    ...
    {
        $aac = $this->getAAC();
        $hasSpinner = $aac->isGrantedPlan('enterprise_package')?true:false;
        ...
        $this->template->set('has_pixalbay', $pixabay);
        ...
        $this->template->set('hasSpinner', $hasSpinner);
...
//     var_dump($this->has_pixalbay);
//  }         
        if($this->has_pixalbay){
    ...
    private function _attach_scripts() {
        ...
        CssJs::getInst()->c_js('twitter/autopixar', 'file-upload');
