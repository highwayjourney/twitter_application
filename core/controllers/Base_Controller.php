...
public  function generateWeighedRandomValue($nodes) {
    ...
    protected function set_default_css()
    {
        $css_array = array(
            array(
                'css' => '//code.jquery.com/ui/1.12.1/themes/cupertino/jquery-ui.css',
                'type' => 'external',
                'location' => 'header'
            ),
            array(
                'css' => '//cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css',
                'type' => 'external',
                'location' => 'header'
            ),
            array(
    ...
    protected function set_default_js()
    {
        $js_array = array(
            ...
            // array(
            //     'js' => 'code.jquery.com/jquery-migrate-3.0.0.min.js',
            //     'type' => 'external',
            //     'location' => 'header'
            // ),            
            // array(
            //     'js' => 'sociboom.dev/public/custom_theme/js/bootstrap.js',
            //     'type' => 'external',
            //     'location' => 'header'
            // ),            
            array(
