...
//                'https://www.googleapis.com/auth/plus.media.upload'
    ...
    public function search_videos($q, $maxResults, $token){
        ...
        try {
            $this->_google->setApplicationName("autosoci");
            $this->_google->setAccessToken($token->data);
            // if($this->_google->isAccessTokenExpired()) {

            //     $this->_google->authenticate();
            //     $NewAccessToken = json_decode($this->_google->getAccessToken());
            //     $this->_google->refreshToken($NewAccessToken->refresh_token);

            // }              
            $youTube = new Google_Service_YouTube($this->_google);          
