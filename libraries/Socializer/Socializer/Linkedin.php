...
class Socializer_Linkedin {
    ...
    */
    public function createPost($data){
        ...
        $content['description'] = $data['url_text'];
        $content['comment'] = $data['description'];
        $content['submitted-url'] = $data['url'];
        if(isset($data['image_name']) && !empty($data['image_name'])) {
            //Not available on cron posts!!!
            //$content['submitted-image-url'] = site_url('/public/uploads/'.$this->_user_id.'/'.$data['image_name']);
            $content['submitted-image-url'] = 'http://app.socimattic.com/public/uploads/'.$this->_user_id.'/'.$data['image_name'];
        }
