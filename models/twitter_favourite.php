 ...
 */
class Twitter_favourite extends DataMapper
{
     ...
     */
    public function setStartFavouriteTime($start_follow_time) {
     ...
     */
    public function setEndFavouriteTime($end_follow_time) {
