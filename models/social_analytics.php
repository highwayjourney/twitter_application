...
class Social_analytics extends DataMapper {
    ...
    const LINKEDIN_ANALYTICS_TYPE = 'linkposts_count';

    const IGPOSTS_ANALYTICS_TYPE = 'igposts_count';

    const FACEBOOK_ANALYTICS_TYPE = 'fbposts_count';
    const FACEBOOK_LIKE_COUNT_ANALYTICS_TYPE = 'facebook_like_count';
    const FACEBOOK_COMMENT_COUNT_ANALYTICS_TYPE = 'facebook_comment_count';

    const PINTEREST_ANALYTICS_TYPE = 'pins_count';
    const PINTEREST_LIKE_COUNT_ANALYTICS_TYPE = 'pinterest_like_count';
    const PINTEREST_REPIN_COUNT_ANALYTICS_TYPE = 'pinterest_repin_count';

    const TWITTER_ANALYTICS_TYPE = 'tweets_count';
    const RETWEETS_ANALYTICS_TYPE = 'retweets_count';
    const FAVOURITES_ANALYTICS_TYPE = 'favourites_count';
    const MENTION_ANALYTICS_TYPE = 'mentions_count';
        
    const TWITTER_RETWEET_COUNT_ANALYTICS_TYPE = 'twitter_retweet_count';
    const TWITTER_FAVOURITE_COUNT_ANALYTICS_TYPE = 'twitter_favourite_count';
     ...
     */
    public static function updateAnalytics($access_token_id, $type, $value, $date = null, $mod = null) {
        if(!$date) {
