...
class User extends DataMapper
{
    ...
    var $has_many = array(
        ...
        'number_of_retweets_twitter',
        'number_of_favourites_twitter',
        'number_of_mentions_twitter',
        'social_group',
        'access_token',
        'rss_feed'       => array(
    ...
    public function getDateToRetweet($access_token_id) {
        return $this->number_of_retweets_twitter
            ->where(array(
                'token_id' => $access_token_id
            ))->order_by('date', 'desc')
            ->get(1);
    } 
    public function getDateToFavourite($access_token_id) {
        return $this->number_of_favourites_twitter
            ->where(array(
                'token_id' => $access_token_id
            ))->order_by('date', 'desc')
            ->get(1);
    }
    public function getDateToMention($access_token_id) {
        return $this->number_of_mentions_twitter
            ->where(array(
                'token_id' => $access_token_id
            ))->order_by('date', 'desc')
            ->get(1);
