    <script type="text/template" id="facebook-search">
        <label class="m-t10">
        <p >Keyword</p>
        <input class="m-b20" type='text' id='facebook_keyword'/>
        </label>
        <button class="m-b20" id="facebook_button">Search</button>
        <div id="ajax-indicator m-t10" >
        </div>
        <div id="facebook-results-region m-t10">
