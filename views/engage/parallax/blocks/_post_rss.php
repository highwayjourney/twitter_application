    ...
    <div class="col-xs-12">
        <div class="tab-content settings_content">
            <div class="tab-pane active">
                <?php echo $this->template->block('post_on', 'parallax/parallax/blocks/_post_on', isset($social_post) ? array('social_post' => $social_post) : array()); ?>
                <?php if($isSupportScheduledPosts): ?>
                    <?php echo $this->template->block('schedule', 'parallax/parallax/blocks/_schedule_block', isset($social_post) ? array('social_post' => $social_post) : array());?>
                <?php endif;?>
                <div class="row">
                    <div class="col-sm-7">
