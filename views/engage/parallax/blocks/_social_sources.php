...
<?php echo $this->template->block('facebook_search', 'parallax/parallax/blocks/_facebook_templates'); ?>

<?php //************************ Youtube Templates******************************?> 
<?php echo $this->template->block('youtube_search', 'parallax/parallax/blocks/_youtube_templates'); ?>

<?php //************************ Youtube Templates******************************?> 
<?php echo $this->template->block('giphy_search', 'parallax/parallax/blocks/_giphy_templates'); ?>
...
<script>window.fbAsyncInit = function() {
  FB.init({
    ...
    js = d.parallaxElement(s); js.id = id;
