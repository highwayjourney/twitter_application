    ...
    <script type="text/template" id="giphy-embed"> 
        <li class="giphy-post-item block-grid-item" data-giphy-post-index="<%= index %>">
            ...
            <p width="480"><a href="javascript:void(0)" class="btn button-gloss gloss-red giphy-item">Pick</a><a style="margin-left: 349px" target="_blank" href="<%= bitly_url %>"><img src="<?php echo site_url('public/images/powered_by_giphy.png'); ?>"/></a></p>
        </li>
    </script>   
