    ...
    <div class="col-xs-12">
        <div class="tab-content settings_content">
            <div class="tab-pane active">
                <form action="<?php echo site_url('twitter/create/post_create');?>" method="POST" id="post-update-form" autocomplete="off">
                    <?php echo $this->template->block('post_to', 'twitter/create/blocks/_post_to'); ?>
                    <?php //echo $this->template->block('bulk_upload', 'twitter/create/blocks/_bulk_upload'); ?>
                    <div class="row">
                    ...
                    <?php echo $this->template->block(
                        'attachment',
                        'twitter/create/blocks/_post_attachment',
                        array(
                            'groups' => $groups,
                    ...
                    echo $this->template->block(
                        'sources',
                        'twitter/create/blocks/_social_sources',
                        array(
                            'postSources' => $socials
                        )
                    ); ?>                     
                    ...
                    <?php endif;?>
                    <?php echo $this->template->block('post_on', 'twitter/create/blocks/_post_on', isset($social_post) ? array('social_post' => $social_post) : array()); ?>
                    <?php if($isSupportScheduledPosts): ?>
                        <?php echo $this->template->block('schedule', 'twitter/create/blocks/_schedule_block', isset($social_post) ? array('social_post' => $social_post) : array());?>
                    <?php endif;?>
                    <?php echo $this->template->block('cron', 'twitter/create/blocks/_post_cron', isset($social_post) ? array('social_post' => $social_post) : array());?>
                </form>
            </div>
        </div>
    </div>
