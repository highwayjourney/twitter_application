        ...
        <div class="row-fluid">
            <div class="body span12">
                    ...
                    <div class="span12">
                        <ul class="media-list clearfix">
                            <li <?php if($social === 'facebook'): ?>class="active"<?php endif; ?>>
                                <a href="<?php echo site_url('twitter/mentions/facebook'); ?>">
                                    <i class="fb"></i> 
                                    Facebook 
                            ...
                            <li <?php if($social === 'twitter'): ?>class="active"<?php endif; ?>>
                                <a href="<?php echo site_url('twitter/mentions/twitter'); ?>">
                                    <i class="tw"></i>
                                    Twitter 
                                    <span class="marker"></span>
                                </a>
							 ...
							 <li <?php if($social === 'google'): ?>class="active"<?php endif; ?>>
                                <a href="<?php echo site_url('twitter/mentions/google'); ?>">
                ...
                <?php else: ?>
                    ...
                    <?php echo $this->template->block('_' . $social, 'twitter/mentions/' . $social); ?>
                    <!-- HERE GOES PARTICULAR SOCIAL BLOCK -->
                    ...
                    <div class="row-fluid">
                        <div class="mentions-block pginationBlock clearfix">
                            <?php 
                                ...
                                $prev_url = site_url('twitter/mentions/' . $social . '?page=' 
                            ...
                            <div class="pgBody">
                                <?php for($i = 1; $i <= $mentions->paged->total_pages; $i += 1): ?>
                                    <?php $page_url = site_url('twitter/mentions/' . $social 
                            ...
                            <?php 
                                ...
                                $next_url = site_url('twitter/mentions/' . $social 
