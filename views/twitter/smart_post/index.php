        ...
        <div class="box">
            ...
            <span class="badge red-bg tool-tiper" data-type="delete" data-id="<?php echo $key; ?>"><a href="#" title="Click to delete from Queue">Delete</a></span>
              ...
              <?php if ($data['source'] == 'giphy'): ?>         
                <?php if(strpos($data['embed_url'], 'httpss')  === false): ?>                   
                ...
                <?php else: ?>
                  <iframe src="<?php echo str_replace('httpss', 'https', $data['embed_url']); ?>" style="display:block" width="480" height="178" frameBorder="0" class="giphy-embed" allowFullScreen></iframe>
                <?php endif; ?>
              <?php endif; ?>            
