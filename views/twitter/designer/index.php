...
<!--                         <ul class="list-unstyled hidden-xs" id="sidebar-footer">
                ...
                <div class="modal-body">
                    <div class="spinner_config">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <h4 class="head_tab"><?= 'Font Color' ?></h4>
                                <label class="">
                                    <span class="cb-inner">
                                        <i><input type="radio" name="fontcolor" value="random" checked="checked"></i>
                                    </span>
                                    Random        
                                </label> 
                                <label class="">
                                    <span class="cb-inner">
                                        <i><input type="radio" name="fontcolor" value="default"></i>
                                    </span>
                                    Use default        
                                </label>                                
                                <h4 class="head_tab"><?= 'Font Family' ?></h4>
    ...
    <div id="overlay">
        <div class="progress-wrapper">
            <h4 class="head_tab"><?= 'Uploading Designs' ?></h4>
            <div class="row">
                <div class="col-xs-3">
                </div>
                <div class="col-xs-6">
                  ...
                  <div class="carousel-caption">
                    <div class="box" data-id="{{ @index }}">                    
                        <div class="box-icon share">
                          <span class="fa fa-2x icon fa-share" title="Click to export Campaign"></span> 
                        </div>                    
                        <div class="box-icon {{ this.state }}">
                          <span class="fa fa-2x icon  fa-thumbs-o-up" title="Click to approve Design"></span> 
                        </div>  
                        <div class="box-icon post">
                          <span class="fa fa-2x icon fa-send" title="Click to Post"></span> 
                        </div>                                                                       
                    </div>
                  </div>
