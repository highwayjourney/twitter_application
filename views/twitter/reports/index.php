...
<div class="p-rl30 p-tb20">
    <div class="row">
        <div class="col-xs-12">
            <h1 class="page-title"><?= lang('social_media_social_reports') ?></h1>
            <div class="row">
                <div class="col-xs-12">
        ...
        <div class="col-sm-12">
            <div class="block_content m-b20">
                ...
                <div class="block_content_body">
                    <div class="row">
                        <form id="facebook-dates" action="<?php echo site_url('twitter/reports/get_chart_data'); ?>">
                            <div class="col-sm-3">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="block_content m-b20">
                ...
                <div class="block_content_body">
                    <div class="row">
                        <form id="twitter-dates" action="<?php echo site_url('twitter/reports/get_chart_data'); ?>">
                            <div class="col-sm-3">
                                <div class="form-group date_calendar">
                                    <input type="text" class="form-control input_date" name="from">
                                </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="block_content m-b20">
                ...
                <div class="block_content_body">
                    <div class="row">
                        <form id="google-dates" action="<?php echo site_url('twitter/reports/get_chart_data'); ?>">
                            <div class="col-sm-3">
                                <div class="form-group date_calendar">
                                    <input type="text" class="form-control input_date" name="from">
                                </div>
