                    ...
                    <ul class="nav nav-tabs settings_tab">
                        <?php foreach($access_tokens as $access_token) : ?>
                            <li class="setting_item <?= ($token['id'] == $access_token['id']) ? 'active' : '' ?> auto token_item"
                                ...
                                <a class="setting_link" href="<?php echo site_url('twitter/activity/google?token_id='.$access_token['id']); ?>" data-toggle="tab">
                                    <i class="ti-folder"></i>
                                    <?= $access_token['name'] ?>
                                </a>
                            </li>
                ...
                <div class="col-xs-12">
                    <ul class="pagination pull-right pginationBlock">
                        <li class="pagination_item">
                            <a href="<?php echo site_url('twitter/activity/google?token_id='.$token['id']); ?>"
                        ...
                        <li class="pagination_item unactive">
                            <a href="<?php echo site_url('twitter/activity/google'); ?>?token_id=<?= $token['id'] ?>&page=<?php echo isset($nextPageToken) ? urlencode($nextPageToken) : ''; ?>"
