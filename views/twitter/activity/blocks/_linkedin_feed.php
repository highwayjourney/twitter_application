            ...
            <div class="dCell">
                ...
                <div class="action clearfix m-t10 social-actions radar">
                    <?php if( $_post->other_field('likable')=='true'):?>
                        ...
                        $like_url = site_url('/twitter/activity/linkedin_');
                        ...
                        <?php endif;?>
                        <?php $comments_url = site_url('twitter/activity/linkedin_get_comments?key='
                            . $key);
                        ?>
                        ...
                        <?php echo $this->template->block('_comments', 'twitter/activity/blocks/_linkedin_comments', array('_post' => $_post)); ?>
                    <?php endif;?>
                </div>
            </div>
        </div>
