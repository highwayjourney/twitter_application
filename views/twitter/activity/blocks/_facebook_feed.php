            ...
            <div class="dCell">
                ...
                <div class="clearfix social_like">
                    ...
                    <?php  $like_url = $is_liked
                        ? site_url('twitter/activity/facebook_dislike')
                        : site_url('twitter/activity/facebook_like');
                    ...
                    <?php $comments_url = site_url('twitter/activity/facebook_get_comments/'. $_post['id']);?>
                    ...
                    <a  href="javascript: void(0)"
                        class="remove-post"
                        data-url="<?php echo site_url('twitter/activity/facebook_remove_comment/'.$_post['id']); ?>"
                        title="Remove"
                        >
                        <i class="ti-close"></i>
                    </a>
                </div>
                <?php echo $this->template->block('_comments', 'twitter/activity/blocks/_facebook_comments', array('_post' => $_post, 'picture' => $fanpicture)); ?>
            </div>
        </div>
    </div>
<?php endforeach; ?>
