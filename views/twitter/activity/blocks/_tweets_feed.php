...
<?php foreach($tweets as $_tweet): ?>
    <div class="web_radar_content dTable mentions-block">
        <div class="dRow">
            ...
            <div class="dCell">
                <div class="author"><a href="<?php echo $radar->getProfileUrl('twitter').$_tweet->user->screen_name;?>" target="_blank"><?php echo $_tweet->user->name; ?></a></div>
                ...
                <?php $retwittedLink = $retwittedClass
                    ? site_url('twitter/activity/unretweet/'. $_tweet->id_str)
                    : site_url('twitter/activity/retweet/'. $_tweet->id_str);
                ?>
                <a class="reply" data-id="<?php echo $_tweet->id_str; ?>" title="Reply"
                   href="<?php echo site_url('twitter/activity/tweet'); ?>"
                ...
                <?php $favoritedLink = !$favoritedClass
                    ? site_url('twitter/activity/favorite/'. $_tweet->id_str)
                    : site_url('twitter/activity/unfavorite/'. $_tweet->id_str);
                ?>
