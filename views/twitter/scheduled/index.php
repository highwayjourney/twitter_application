<div class="p-rl30 p-tb20">
    <div class="row">
        <div class="col-xs-12">
            <h1 class="page-title"><?= lang('social_media_scheduled_posts')?></h1>
            <div class="row">
                <div class="col-xs-12">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <!--     <li class="tab tab-active">
                ...
                <li class="active">
                    <a href="#Scheduled" data-toggle="pill" >
                        Scheduled
                    </a>
                </li>
            <!--     <li class="tab tab-active">
                        ...
                        <div id="ajax-container">
                            <?php
                                echo $this->template->block(
                                    '_scheduled_post',
                                    'twitter/scheduled/blocks/_post',
                                    array('posts' => $posts)
                                );
                            ?>
                        </div>            
...
<!--                                                                                                         <a  href=""
                                                                                                        ...
                                                                                                        <a class="remove_link"
                                                                                                           href="<?php echo site_url('twitter/cron_posts/delete/'.$post->id);?>"
                                                                                                           data-id="<?= $post->id ?>"
                                                                                                        >
                                                                                                            <?= lang('remove') ?>
                                                                                                        </a>
                        ...
                        <?php echo $this->template->block('_modal_edit_cron', 'twitter/cron_posts/blocks/_modal_edit_cron'); ?>        
                    </div>
                </div> 
            </div>   
        </div>
