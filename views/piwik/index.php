...
<div class="p-rl30 p-tb20">
    <div class="row">
        <div class="col-xs-12">
            <h1 class="page-title"><?= lang('analytics_piwik') ?></h1>
        </div>
    </div>
</div>
        ...
        <div class="col-xs-12">
            <ul class="nav nav-tabs settings_tab">
                <li class="setting_item active auto">
                    <a class="setting_link" href="<?php echo site_url('piwik#web'); ?>">
                        <i class="ti-user"></i>
                        <?= lang('web_traffic') ?>
                    </a>
                </li>
                <li class="setting_item auto">
                    <a class="setting_link" href="<?php echo site_url('piwik#search'); ?>">
                        <i class="ti-search"></i>
                        <?= lang('search_traffic') ?>
                    </a>
                </li>
                <li class="setting_item auto">
                    <a class="setting_link" href="<?php echo site_url('piwik#websites'); ?>">
                        <i class="ti-direction"></i>
                        <?= lang('websites_traffic') ?>
                    </a>
                </li>
                <li class="setting_item auto">
                    <a class="setting_link" href="<?php echo site_url('piwik#adwords'); ?>">
                        <i class="ti-key"></i>
                        <?= lang('adwords_traffic') ?>
                    </a>
                </li>
                <li class="setting_item auto">
                    <a class="setting_link" href="<?php echo site_url('piwik#social'); ?>">
                        <i class="ti-key"></i>
                        <?= lang('social_traffic') ?>
                    </a>
                </li>
...
<script id="table-hidden-template" type="text/x-handlebars-template">
    {{#if result}}
