...
<div class="p-rl30 p-tb20">
    <div class="row">
        <div class="col-xs-12">
            <h1 class="page-title"><?= lang('settings_social_media_analytics', [ucfirst($token->type)]); ?></h1>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-xs-6">
            <div class="block_content m-b20">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div id="chartbox-mentions_count">
        ...
        <div class="col-xs-6">
            <div class="block_content m-b20">
                <div class="row">
                    <div class="col-xs-12 clearfix">
                        <h2 class="block_content_title pull-sm-left w-100">
                            <?= 'Posted Content Retweets' ?>
                        </h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div id="chartbox-twitter_retweet_count">
        ...
        <div class="col-xs-6">
            <div class="block_content m-b20">
                <div class="row">
                    <div class="col-xs-12 clearfix">
                        <h2 class="block_content_title pull-sm-left w-100">
                            <?= 'Posted Content Favourites' ?>
                        </h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <div id="chartbox-twitter_favourite_count">
