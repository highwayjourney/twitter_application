...
<div class="p-rl30 p-tb20">
    <div class="row">
        <div class="col-xs-12">
            <h1 class="page-title"><?= lang('settings_social_media') ?></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <div class="col-sm-6 col-lg-4 m-b20 account_item">
                        <div class="row">
                            ...
                            <div class="col-sm-6 sm-right">
                                <a href="<?php echo site_url('settings/socialmedia/'.$type);?>">
                                    <img src="http://app.autosoci.com/public/images/connect-<?php echo $type; ?>.png" class="img-responsive">
                                </a>
                            </div>
                            <?php endif; ?>
                        </div>
...
<?php echo $this->template->block('instagram_credential', 'blocks/modal/settings/socialmedia/instagram'); ?>
