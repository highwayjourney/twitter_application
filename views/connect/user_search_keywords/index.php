...
<div class="p-rl30 p-tb20">
    <div class="row">
        <div class="col-xs-12">
            <h1 class="page-title"><?= lang('settings_user_search_keywords') ?></h1>
        </div>
    </div>
    <div class="row">
        <div class="col-xs-12">
...
<div class="main_block">
    ...
    <div class="row custom-form">
        <div class="col-md-10 col-lg-8">
            <form id="user-search-keywords-form" action="<?php echo site_url('connect/user_search_keywords'); ?>" method="POST">
