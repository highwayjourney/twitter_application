 ...
 */
$config['site_title']                 = "Socimattic";       // Site Title, example.com
$config['admin_email']                = "cesarquintini@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['superadmin_group']           = 'superadmin';        // Super administrators group, use name
$config['admin_group']                = 'admin';
$config['manager_group']              = 'managers';
$config['collaborator_group']         = 'collaborators';
