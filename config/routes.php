...
|
*/
//$route['connect/engagement_settings/(:num)'] = "settings/socialmedia/edit_account/(:num)";
...
//$route['assets'] = 'social/autopixar';
$route['twitter'] = 'twitter/create/redirect';
$route['twitter/create'] = 'twitter/create/update';
